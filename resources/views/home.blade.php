<x-layout>
  <main class="max-w-[80rem] flex px-2 my-10 mx-auto">
    <aside class="w-fit mr-5 border-neutral-500 border-r pr-10">
    ...
    <form hx-post="/tweet">
      @csrf
      <textarea
        class="p-2 rounded-md border border-neutral-500 w-[40rem] text-lg mb-2 h-[7rem]"
        required
        placeholder="What's on your mind"
        style="resize: none;" required name="tweet"></textarea>
      <button
        class="bg-white text-black block px-4 font-semibold text-lg py-2 rounded-lg cursor-pointer"
